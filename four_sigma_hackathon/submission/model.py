"""
THIS FILE IS A COPY OF ensemble_model.py — kept as `model.py` because the
scoring framework loads `submission/model.py` by convention. Edit ensemble_model.py
and re-copy to keep the two in sync.
